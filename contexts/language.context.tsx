...
const translations: Record<Language, Record<string, string>> = {
  id: {
    ...
    'strengths.fleet.desc': '200+ unit heavy equipment dari brand terkemuka seperti FAW, HOWO, SANY, XCMG, Zoomlion, dll dengan kapasitas hingga 2300 ton.',
    ...
    'strengths.trusted.title': 'Dipercaya oleh PT Greatwall Drilling Asia Pacific',
    'strengths.trusted.desc': 'Kolaborasi strategis sebagai mitra utama PT Greatwall Drilling Asia Pacific.',
    ...
    'about.coreStrengths.title': 'Kekuatan Inti',
    'about.coreStrengths.overTitle': 'Kekuatan Kami',
    'about.coreStrengths.fleet.title': 'Fleet Terlengkap:',
    'about.coreStrengths.fleet.desc': '200+ unit heavy equipment dari berbagai kategori dan kapasitas.',
    'about.coreStrengths.team.title': 'Tim Berpengalaman:',
    'about.coreStrengths.team.desc': 'Operator, teknisi, dan engineer bersertifikat serta berpengalaman.',
    'about.coreStrengths.coverage.title': 'Coverage Area Luas:',
    'about.coreStrengths.coverage.desc': 'Melayani seluruh Indonesia dengan base operation di Jakarta dan Duri.',
    'about.coreStrengths.quality.title': 'Quality Assurance:',
    'about.coreStrengths.quality.desc': 'Sistem QAQC terintegrasi untuk memastikan standar kualitas terbaik.',
    'about.coreStrengths.support.title': '24/7 Support:',
    'about.coreStrengths.support.desc': 'Layanan maintenance dan emergency response siap 24 jam.',
  ...
  en: {
    ...
    'strengths.fleet.desc': '200+ heavy equipment units from leading brands such as FAW, HOWO, SANY, XCMG, Zoomlion, etc., with capacity up to 2300 tons.',
    'strengths.safety.title': 'Safety Record',
    'strengths.safety.desc': 'Outstanding safety track record with zero accidents for 24 consecutive months.',
    'strengths.trusted.title': 'Trusted by PT Greatwall Drilling Asia Pacific',
    'strengths.trusted.desc': 'Strategic collaboration as a key partner of PT Greatwall Drilling Asia Pacific.',
    ...
    'about.coreStrengths.title': 'Core Strengths',
    'about.coreStrengths.overTitle': 'Our Strength',
    'about.coreStrengths.fleet.title': 'Comprehensive Fleet:',
    'about.coreStrengths.fleet.desc': '200+ heavy equipment units across diverse categories and capacities.',
    'about.coreStrengths.team.title': 'Experienced Team:',
    'about.coreStrengths.team.desc': 'Certified and seasoned operators, technicians, and engineers.',
    'about.coreStrengths.coverage.title': 'Extensive Coverage:',
    'about.coreStrengths.coverage.desc': 'Serving clients across Indonesia with base operations in Jakarta and Duri.',
    'about.coreStrengths.quality.title': 'Quality Assurance:',
    'about.coreStrengths.quality.desc': 'Integrated QAQC system ensuring the highest quality standards.',
    'about.coreStrengths.support.title': '24/7 Support:',
    'about.coreStrengths.support.desc': 'Maintenance and emergency response services available around the clock.',
    ...
    'contact.jakarta.phone': 'Semua email yg dikirim dari client dikirim ke info@mk.bersama.com',
    // 'contact.jakarta.fax': '+62 21 4682 1235',
    'contact.duri.title': 'Duri Yard - Operational Base',
    'contact.duri.address': 'Jl. Lintas Timur KM 85, Duri, Bengkalis, Riau 28784, Indonesia',
    'contact.duri.phone': '+62 765 41234',
